...
<html>
    ...
    <body>
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div id="iip_image"><img src="http://lxbisel1:8080/wlziip?PIT=90&YAW=90&DST=150&WLZ=/data0/local/nginx/html/compound.wlz&sel=0&CVT=png"/></div>
                </div>
                <div class="col-md-3">
                    <br />
        ...
        <div class="container">
            <div class="row">                
                <div class="col-md-6">
                    <span><b>Image being displayed:</b> </span><span id="url">http://lxbisel1:8080/wlziip?PIT=90&YAW=90&DST=150&WLZ=/data0/local/nginx/html/compound.wlz&sel=0&CVT=png</span>
                </div>              
                <div class="col-md-2">
        ...
        <script>
            var originalURL = "http://lxbisel1:8080/wlziip?PIT=90&YAW=90&DST=150&WLZ=/data0/local/nginx/html/compound.wlz&sel=0&CVT=png";
            var originalDST = 150;
            var originalPIT = 90;
            var originalYAW = 90;
            var newTissue = "0";
            ...
            function updateImage() {
                newTissue = document.getElementById("tissueSelect").value;
                if (newTissue === "0") {
                    newURL = "http://lxbisel1:8080/wlziip?PIT=" + newPIT + "&YAW=" + newYAW + "&DST=" + newDST + "&WLZ=/data0/local/nginx/html/compound.wlz&sel=0&CVT=png";
                } else {
                    newURL = "http://lxbisel1:8080/wlziip?PIT=" + newPIT + "&YAW=" + newYAW + "&DST=" + newDST + "&WLZ=/data0/local/nginx/html/compound.wlz&sel=0&sel=" + newTissue + ",255,0,0,128" + "&CVT=png";
                }
